package com.example.wordpassword.framework;
...
/**
 * Created by deepaksood619 on 12/6/16.
 */
public class CustomContentProvider extends ContentProvider {

    private static final String TAG = CustomContentProvider.class.getSimpleName();

    private static final String PROVIDER_NAME = "com.example.wordpassword.provider";
