...
int p=0;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mTagCloudView = new TagCloudView(this, width, height, myTagList,objects ); //passing current context 
		System.out.println("value for objects: "+objects);
	...
	private List<Tag> createTags(ArrayList<String> objects){
