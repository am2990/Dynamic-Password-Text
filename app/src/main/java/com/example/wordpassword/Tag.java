...
public class Tag implements Comparable<Tag>{
	...
	public Tag() {
		this("", 0f, 0f, 0f, 1.0f, 0, "", false);
	}	
	
	public Tag(String text, int popularity) {
		this(text, 0f, 0f, 0f, 1.0f, popularity, "", false);
	}	
	public Tag(String text, int popularity, String url) {
		this(text, 0f, 0f, 0f, 1.0f, popularity, url, false);
	}	
	public Tag(String text,float locX, float locY, float locZ) {
		this(text, locX, locY, locZ, 1.0f, DEFAULT_POPULARITY, "", false);
	}
	public Tag(String text,float locX, float locY, float locZ, float scale) {
		this(text, locX, locY, locZ, scale, DEFAULT_POPULARITY, "", false);
	}
	...
	public void toggle() {
		...
		if(set){
			...
			setColorR(56);setColorB(57);setColorG(200);
			this.set = true;
		}	
